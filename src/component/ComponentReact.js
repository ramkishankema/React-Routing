...
const ComponentReact = () => {
    return( <div className='details-text'>
                ...
                The code written in React is made of entities called components. React includes an in-memory data-structure cache that updates the browser’s display DOM effectively.
